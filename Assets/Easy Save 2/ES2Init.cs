...
public class ES2Init : MonoBehaviour
{
	...
	public static void Init()
	{
        ...
        // MY EASY SAVE
        ES2TypeManager.types[typeof(TaskData)] = new ES2_TaskData();
        ES2TypeManager.types[typeof(BaseItemData)] = new ES2_BaseItemData();
        ES2TypeManager.types[typeof(EquipmentItemData)] = new ES2_EquipmentItemData();
        ES2TypeManager.types[typeof(System.TimeSpan)] = new ES2_TimeSpan();
